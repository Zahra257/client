...
//     if(errorMsg=="") 
//         Axios.post(`http://localhost:9000/api/forget-password/${userInput.email}/Token/${Token.userInput}`,userInput)
...
//                                  placeholder="password" onFocus={() => setErrorMsg("")}
...
function Resetpassword() {
    ...
    if(errorMsg=="") 
        ...
        Axios.post(`http://localhost:9000/api/forget-password/${userInput.email}/Token/${userInput.Token}`,userInput)
        .then(data=>console.log(data))
        .catch(err=>console.log(err))
                    ...
                    <div className="card-body">
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="input-group form-group">
                                <div className="input-group-prepend">
                                    <span className="input-group-text">
                                        <i className={errorMsg.includes("Repeated Token") == "" ? "fas fa-key" : "fas fa-key text-danger"}></i></span>
                                </div>
                                <input
                                    onFocus={() => setErrorMsg("")}
                                    onChange={handleChangeInput}
